      ...
      <section className="card dashboard-elevated reveal-up stagger-1 overflow-hidden p-0">
        <div className="grid gap-0 md:grid-cols-2">
          ...
          <div className="space-y-3 p-5">
            ...
            <p className="text-sm text-zinc-300">{nextRace.name} · {nextRace.circuit}</p>
            <div className="text-sm text-zinc-200">
              <p>赛段：{nextRace.session}</p>
              <p>开赛时间：{nextRace.localTime}</p>
            </div>
            <p className="text-xs text-zinc-400">当前数据为演示用模拟数据，页面样式与交互已按仪表盘布局准备。</p>
          </div>
        </div>
      </section>
